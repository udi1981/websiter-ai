...
const heroVariants: SectionVariant[] = [
  ...
  base({
    id: 'hero-apple-clean',
    category: 'hero',
    name: 'Apple Clean Hero',
    description: 'Premium split-layout hero with product focus, generous whitespace, and stat bar. Apple-inspired.',
    tags: ['premium', 'clean', 'product', 'split'],
    industries: [...ECOMMERCE_INDUSTRIES, 'tech', 'consumer_electronics'],
    features: ['split-layout', 'product-focus', 'stat-bar', 'premium-cta'],
  ...
  base({
    id: 'hero-tech-dark',
    category: 'hero',
    name: 'Tech Dark Cinematic',
    description: 'Dark cinematic hero with gradient glow orbs, glassmorphism feature cards, and neon accents.',
    tags: ['dark', 'cinematic', 'tech', 'glow'],
    industries: ['tech', 'saas', 'fintech', 'ai'],
    features: ['dark-theme', 'glow-orbs', 'glass-cards', 'pulse-badge'],
    animationLevel: 'moderate',
    requiredMedia: [],
    props: heroProps,
    minHeight: '100vh',
  ...
  base({
    id: 'hero-family-warm',
    category: 'hero',
    name: 'Family Warm Trust',
    description: 'Warm split-layout hero with trust cues, rounded elements, and family-safe messaging.',
    tags: ['family', 'warm', 'trust', 'safe', 'kids'],
    industries: ['kids', 'family', 'education', ...ECOMMERCE_INDUSTRIES],
    features: ['split-layout', 'trust-cues', 'rounded-cta', 'safety-badges'],
    animationLevel: 'minimal',
    requiredMedia: [media('product-img', 'product', 'image', '4:3')],
    props: heroProps,
    minHeight: '85vh',
    maxContentWidth: 'xl',
  }),
