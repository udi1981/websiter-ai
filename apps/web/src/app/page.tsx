      ...
      <section id="templates" className="relative border-t border-border bg-bg-secondary py-24 md:py-32">
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Cafe Bloom', category: 'Restaurant', image: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=600&q=80', color: 'bg-accent' },
              { name: 'LaunchPad SaaS', category: 'SaaS', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80', color: 'bg-primary' },
              { name: 'StyleShop', category: 'E-commerce', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&q=80', color: 'bg-success' },
              { name: 'Artfolio', category: 'Portfolio', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80', color: 'bg-secondary' },
              { name: 'PropHome', category: 'Real Estate', image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80', color: 'bg-primary' },
              { name: 'FitLife Pro', category: 'Fitness', image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600&q=80', color: 'bg-accent' },
            ].map((template, i) => (
              <div key={template.name} className={`reveal reveal-delay-${(i % 3) + 1} group rounded-2xl border border-border bg-bg overflow-hidden hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 hover-lift`}>
                <div className="relative h-48 overflow-hidden cursor-pointer" onClick={() => setPreviewTemplate(previewTemplate === i ? null : i)}>
                  <Image
                    src={template.image}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span className="rounded-full bg-white/90 px-5 py-2 text-xs font-bold text-bg shadow-lg hover:scale-105 transition-transform">
                      Preview
                    </span>
                  </div>
                </div>
            ...
            {previewTemplate !== null && (() => {
              const templates = [
                { name: 'Cafe Bloom', category: 'Restaurant', image: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1200&q=80' },
                { name: 'LaunchPad SaaS', category: 'SaaS', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80' },
                { name: 'StyleShop', category: 'E-commerce', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80' },
                { name: 'Artfolio', category: 'Portfolio', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=1200&q=80' },
                { name: 'PropHome', category: 'Real Estate', image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&q=80' },
                { name: 'FitLife Pro', category: 'Fitness', image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1200&q=80' },
              ]
              const t = templates[previewTemplate]
              return (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={() => setPreviewTemplate(null)}>
                  <div className="relative w-full max-w-5xl rounded-2xl border border-border bg-bg-secondary shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center justify-between border-b border-border px-6 py-4">
                      <div>
                        <h3 className="text-lg font-bold text-text">{t.name}</h3>
                        <p className="text-xs text-text-muted">AI-generated {t.category.toLowerCase()} template</p>
                      </div>
                      <div className="flex items-center gap-3">
                        <Link href="/login" className="rounded-full bg-gradient-to-r from-primary to-primary-hover px-5 py-2 text-xs font-semibold text-white hover:shadow-lg hover:shadow-primary/30 transition-all">
                          Use This Template
                        </Link>
                        <button onClick={() => setPreviewTemplate(null)} className="h-8 w-8 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-text transition-colors">
