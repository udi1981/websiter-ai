  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-text mb-2">Failed to load site creator</h1>
        <p className="text-text-muted mb-8">
          Something went wrong while setting up the new site flow. Please try again.
        </p>
        <button
          onClick={() => reset()}
